...
const FAQ_ITEMS = [
  ...
  { q: "Как считается сдельная оплата?", a: "Оплата начисляется за килограммы: чем больше собрал — тем больше получил. Для местных работников расчёт производится раз в 3 дня." },
...
function ConditionsSection() {
  const conditions = [
    { icon: "UtensilsCrossed", title: "Питание", desc: "Вахтовым работникам — 3-разовое питание (завтрак, обед, ужин). Для местных и приезжающих на день — только обед в саду.", badge: "Бесплатно", grad: "rgba(255,92,0,0.12)", bord: "rgba(255,92,0,0.2)" },
    { icon: "BedDouble", title: "Проживание", desc: "Бесплатное общежитие предоставляется только в садах Агронома. Горячая вода, душ, Wi-Fi.", badge: "Агроном", grad: "rgba(0,194,255,0.1)", bord: "rgba(0,194,255,0.2)" },
